...
function addCompetencia()
{
    ...
    $('#competencias').append('<div class="col-sm-6 form-group"><label>Descrição</label><input id="comp'+countComp+'" class="form-control" /><button id="comp'+countComp+'_rmv" class="btn btn-danger" onClick="removeCat(this)">-</button></div>');
    countComp++;
}

function removeCat(campo)
{
